...
const InnerArm = (props) => {

    const ArmStuff = useContext(ArmContext);
    const ArmState = ArmStuff.state;
    
    const itemID = props.navigation.getParam("id");
    const itemDetails = ArmState.find((itemDetails) => {
